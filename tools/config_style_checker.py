...
def main():
    ...
    parser.add_argument('-m','--module', help='only search specified module component folder', required=False, default="")
    args = parser.parse_args()

    # Allow running from root directory as well as from inside the tools directory
    rootDir = ".."

    for root, dirnames, filenames in os.walk(rootDir + '/components/' + args.module):
